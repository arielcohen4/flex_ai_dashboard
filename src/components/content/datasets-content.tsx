          ...
          >
            ...
            <div className='space-y-2'>
              ...
              <div className='flex flex-wrap gap-2'>
                <Badge variant="secondary">{roundToK(app.train_rows_count)} train rows</Badge>
                {app.eval_rows_count && <Badge variant="secondary">{roundToK(app.eval_rows_count)} eval rows</Badge>}
                <Badge variant="secondary">{roundToK(app.max_tokens)} max tokens</Badge>
                <Badge variant="secondary">{roundToK(app.total_tokens)} tokens</Badge>
              </div>
            </div>
          </li>
        ))}
